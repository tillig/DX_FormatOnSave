...
namespace DX_FormatOnSave
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="PluginOptionsPage" /> class.
		/// </summary>
		...
		/// <summary>
		/// Loads the base set of options.
		/// </summary>
		/// <returns>
		/// An <see cref="OptionSet"/> loaded from storage.
		/// </returns>
		protected override OptionsContainer LoadOptions()
		{
			return this.LoadOptions<OptionSet>();
		}
